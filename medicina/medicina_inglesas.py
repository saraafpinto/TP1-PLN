...
f = open("../Dados/medicina_inglesas.txt", "r", encoding="utf8") #se der problemas por 
texto = f.read()

texto = re.sub(r'\s+Índice de denominacións inglesas\s+\d+\n', '\n', texto)
texto = re.sub(r'([a-z])\n([a-z])', r'\1 \2', texto)
...
gera_json("medicina_inglesas.json", conceitos_dict)